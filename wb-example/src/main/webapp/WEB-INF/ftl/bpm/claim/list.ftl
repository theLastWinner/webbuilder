...
<div class="mini-fit" style="height:100px;">
    <div id="grid" class="mini-datagrid" ajaxOptions="{type : 'get'}" pageSize="20" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div field="mainFormData.request_name" width="80" align="center" headerAlign="center" allowSort="false">申请人</div>
            <div field="mainFormData.reson" width="160" align="center" headerAlign="center" allowSort="false">申请理由</div>
...
<script>
    ...
    var request;
    function init() {
        grid.setUrl(getServicePath("/bpm/process/claim/"));
    ...
    grid.on("drawcell", function (e) {
        var row = e.record,
                ...
                value = e.value;
        if (field == 'action') {
            var html ="<a href='javascript:doClaim()'>签收</a>";
    ...
    function doClaim() {
       ...
       request.post("/bpm/process/claim/"+row.id,{},function(e){
           mini.alert(e.data);
       })
    }

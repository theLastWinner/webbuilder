...
<head lang="cn">
    ...
    <script type="text/javascript" charset="utf-8"
            src="${config.get('resources','basePath',basePath)}resources/boot.js"></script>
    <script type="text/javascript" charset="utf-8"
            src="${config.get('resources','basePath',basePath)}plugins/miniui/root.js"></script>
</head>
<body>
<!--工具栏-->

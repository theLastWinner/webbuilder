package org.webbuilder.utils.office.excel.html;
...
public class Excel2Html {
	 ...
	 */
	public static Excel2Html create(Workbook wb, Appendable output) {
		return new Excel2Html(wb, output);
	}
	 ...
	 * @return An object for converting the workbook to HTML.
	 */
	public static Excel2Html create(String path, Appendable output) throws IOException {
	...
	private Excel2Html(Workbook wb, Appendable output) {
		if (wb == null)
